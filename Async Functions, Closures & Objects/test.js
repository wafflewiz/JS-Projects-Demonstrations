...
loadImages().then((images) => {
    ...
    let p2FrameCount = 0;
    let lengthOfArray = 0;
    var lastFrameTimeMs = 0; // Timestamp of the last frame
    var maxFPS = 60; // Maximum desired FPS
    var timestep = 1000 / maxFPS; // Timestep between frames
    ...
    function animateP1() {
        ...
        switch (player1.currentAnimState) {              
            ...
            case "Standing":
                ...
                if (p1CurrentLoopIndex == lengthOfArray){
                    console.log("loop index is " + p1CurrentLoopIndex)
                    p1CurrentLoopIndex = 0;
                }
            break;    
        }
